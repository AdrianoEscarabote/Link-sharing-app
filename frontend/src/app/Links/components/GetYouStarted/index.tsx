...
const GetYouStarted = () => {
  return (
    <section className="flex flex-col items-center gap-10 bg-almost_white dark:bg-dark-bg-1 dark:border dark:border-border p-5 rounded-xl">
      <Image
      ...
      <div className="w-full max-w-[488px] flex flex-col items-center text-center justify-center gap-6">
        <h2 className="HeadingM text-almost_dark dark:text-grey-100">
