    ...
    >
      ...
      {optionsOpen ? (
        <div
          ...
          className={`${style.container} z-50 px-4 absolute top-12 flex flex-col items-start bg-white border border-1 border-light_gray w-full rounded-lg h-96 overflow-y-scroll `}
